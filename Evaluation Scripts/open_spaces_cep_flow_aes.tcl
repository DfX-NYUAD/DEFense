...
foreach a [get_db insts *aes*key_reg*] {
...
set min_y [expr $min_y - 50]
set max_y [expr $max_y + 50]
checker_board_blkg [lindex [get_db current_design .core_bbox.] 0 0] [expr $min_y - 75] [lindex [get_db current_design .core_bbox.] 0 2] [expr $max_y + 75] 85
...
foreach a [get_db insts *aes*key_reg*] {      
	...
	lappend key_rows [get_obj_in_area -area [expr $c_x - 50] [expr $c_y - 50] [expr $c_x + 50] [expr $c_y + 50] -obj_type row]
}
